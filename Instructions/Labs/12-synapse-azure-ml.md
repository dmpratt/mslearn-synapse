...
4. In the PowerShell pane, enter the following commands to clone this repo:
    ...
    ```
    rm -r mslearn-synapse -f
    git clone https://github.com/dmpratt/mslearn-synapse.git
    ```

5. After the repo has been cloned, enter the following commands to change to the folder for this lab and run the **setup.ps1** script it contains:

    ```
    cd mslearn-synapse/Allfiles/Labs/12
    ./setup.ps1
    ```
...
9. When the script has finished, in the Azure portal, view the **rgp-mlwkshop-*xxxxxxx*** resource group that it created. This should include the following resources:
...
> **Tip**: If, after running the setup script you decide not to complete the lab, be sure to delete the **rgp-mlwkshop-*xxxxxxx*** resource group that was created in your Azure subscription to avoid unnecessary Azure costs.
...
1. In the **rgp-mlwkshop-*xxxxxxx*** resource group, select the **synapse*xxxxxxx*** Synapse workspace.
...
1. Switch to the browser tab containing the Azure portal and view the **rgp-mlwkshop-*xxxxxxx*** resource group.
...
1. Return to the **rgp-mlwkshop-*xxxxxxx*** resource group.
...
3. Select the **rgp-mlwkshop-*xxxxxxx*** resource group.
4. At the top of the **Overview** page for your resource group, select **Delete resource group**.
5. Enter the **rgp-mlwkshop-*xxxxxxx*** resource group name to confirm you want to delete it, and select **Delete**.
