...
Data *engineers* often use Spark notebooks as one of their preferred tools to perform *extract, load, and transformation (ELT)* activities that transform data from one format or structure to another.

In this lab, you'll use a Spark notebook in Azure Synapse Analytics to transform data in files.
